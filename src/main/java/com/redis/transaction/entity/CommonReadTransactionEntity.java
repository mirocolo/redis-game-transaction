...
/**
 * Created by jiangwenping on 16/12/7. 读取实体
 */
public class CommonReadTransactionEntity extends AbstractGameTransactionEntity {

	public CommonReadTransactionEntity(GameTransactionEntityCause cause, String key,
